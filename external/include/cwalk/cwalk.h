 ...
 */
CWK_PUBLIC size_t cwk_path_get_absolute(const wchar_t *base, const wchar_t *path,
 ...
 */
CWK_PUBLIC size_t cwk_path_get_relative(const wchar_t *base_directory,
 ...
 */
CWK_PUBLIC size_t cwk_path_join(const wchar_t *path_a, const wchar_t *path_b,
  wchar_t *buffer, size_t buffer_size);
 ...
 * @return Returns the total amount of characters of the full, combined path.
 */
CWK_PUBLIC size_t cwk_path_join_multiple(const wchar_t **paths, wchar_t *buffer,
  size_t buffer_size);
 ...
 */
CWK_PUBLIC void cwk_path_get_root(const wchar_t *path, size_t *length);
 ...
 */
CWK_PUBLIC size_t cwk_path_change_root(const wchar_t *path, const wchar_t *new_root,
  wchar_t *buffer, size_t buffer_size);
 ...
 */
CWK_PUBLIC bool cwk_path_is_absolute(const wchar_t *path);
 ...
 */
CWK_PUBLIC bool cwk_path_is_relative(const wchar_t *path);
 ...
 */
CWK_PUBLIC void cwk_path_get_basename(const wchar_t *path, const wchar_t **basename,
  size_t *length);
 ...
 * not truncated.
 */
CWK_PUBLIC size_t cwk_path_change_basename(const wchar_t *path,
 ...
 */
CWK_PUBLIC void cwk_path_get_dirname(const wchar_t *path, size_t *length);
 ...
 */
CWK_PUBLIC bool cwk_path_get_extension(const wchar_t *path, const wchar_t **extension,
  size_t *length);
 ...
 */
CWK_PUBLIC bool cwk_path_has_extension(const wchar_t *path);
 ...
 * truncated.
 */
CWK_PUBLIC size_t cwk_path_change_extension(const wchar_t *path,
 ...
 * truncated.
 */
CWK_PUBLIC size_t cwk_path_normalize(const wchar_t *path, wchar_t *buffer,
  size_t buffer_size);
 ...
 */
CWK_PUBLIC size_t cwk_path_get_intersection(const wchar_t *path_base,
 ...
 */
CWK_PUBLIC bool cwk_path_get_first_segment(const wchar_t *path,
 ...
 * @return Returns true if there is a segment or false if there is none.
 */
CWK_PUBLIC bool cwk_path_get_last_segment(const wchar_t *path,
  struct cwk_segment *segment);
 ...
 */
CWK_PUBLIC bool cwk_path_is_separator(const wchar_t *str);
 ...
 */
CWK_PUBLIC enum cwk_path_style cwk_path_guess_style(const wchar_t *path);
